...
<div style="border-radius: 30px; height: 10cm; padding: 30px; background-image: url('/ReadMe/Book_Project/images/book.jpeg'); background-size: cover;">
	<span style="font-size: 60px; font-weight: bold;">도서목록<br></span>
		<span style="font-size: 25px;">BookList</span>
</div>
				...
				try{
					...
					while(rs.next()){
						...
						<div style="flex-direction: column; padding-left: 20px; padding-right: 20px; flex: 0 0 calc(33.33% - 40px); margin: auto ; padding-bottom: 40px; ">
							...
							<p> <a href="book_detail.jsp?id=<%=rsbookID%>"><button type="button" style="background-color: lightsalmon; border-radius: 30px; border: none;">상세 정보</button></a>
						</div>
						<%
					}
